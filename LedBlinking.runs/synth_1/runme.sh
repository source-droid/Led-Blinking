...
HD_PWD='F:/Digital System Design/LedBlinking/LedBlinking.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Blinky_1Hz.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Blinky_1Hz.tcl
