...
HD_PWD='F:/Digital System Design/LedBlinking/LedBlinking.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Blinky_1Hz.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Blinky_1Hz.tcl -notrace
